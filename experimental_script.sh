...
new_client_ids=(69 53 26 87 7 98 39 1 74)

for client_id in "${new_client_ids[@]}"
do
  echo "Running with client_id $client_id in Cifar10"
  echo "dfedcad"
  python main.py --fl_method dfedcad --dataset_name cifar10 --alpha 0.4 --model lenet --local_epochs 1 --lr 0.0005 --batch_size 32 --n_rounds 50 --minimum_join_rounds 25 --optimizer_name adam --seed 42 --device cuda --split_method dirichlet --lambda_alignment 10 --base_decay_rate 0.1 --set_single_delay_client $client_id
  echo "dfedavg"
  python main.py --fl_method dfedavg --dataset_name cifar10 --alpha 0.4 --model lenet --local_epochs 1 --lr 0.001 --batch_size 32 --n_rounds 50 --minimum_join_rounds 25 --optimizer_name adam --seed 42 --device cuda --split_method dirichlet --set_single_delay_client $client_id
  echo "dfedmtkdrl"
  python main.py --fl_method dfedmtkdrl --dataset_name cifar10 --alpha 0.4 --model lenet --local_epochs 1 --lr 0.001 --batch_size 32 --n_rounds 50 --minimum_join_rounds 25 --optimizer_name adam --seed 42 --device cuda --split_method dirichlet  --lambda_alignment 0.1 --set_single_delay_client $client_id
  echo "dfedpgp"
  python main.py --fl_method dfedpgp --dataset_name cifar10 --alpha 0.4 --model lenet --local_epochs 1 --lr 0.0005 --batch_size 32 --n_rounds 50 --minimum_join_rounds 25 --optimizer_name adam --seed 42 --device cuda --split_method dirichlet  --set_single_delay_client $client_id
done
...
do
  ...
  echo "dfedmtkdrl"
  python main.py --fl_method dfedmtkdrl --dataset_name emnist --alpha 0.4 --model leafcnn1 --local_epochs 1 --lr 0.001 --batch_size 32 --n_rounds 50 --minimum_join_rounds 25 --optimizer_name adam --seed 42 --device cpu --split_method dirichlet --lambda_kd 0.1 --set_single_delay_client $client_id
  echo "dfedpgp"
